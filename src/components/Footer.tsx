...
const Footer = () => {
  ...
  return (
    <footer className="py-12 bg-mostar-dark relative overflow-hidden">
      <div className="absolute inset-0 bg-cyber-grid bg-[length:15px_15px] opacity-5 z-0"></div>
            ...
            <div className="flex space-x-4">
              {['twitter', 'linkedin', 'github', 'discord'].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/60 hover:text-mostar-light-blue hover:border-mostar-light-blue/50 transition-colors"
                >
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((item) => (
              <a key={item} href="#" className="text-white/40 text-sm hover:text-mostar-light-blue transition-colors">
                {item}
              </a>
            ))}
          </div>
